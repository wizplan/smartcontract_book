...
import RoomFactory from './contracts/RoomFactory'
import styled, { createGlobalStyle } from 'styled-components'
import reset from 'styled-reset'
import { ArrowLeft, Plus } from 'styled-icons/fa-solid'
import axios from 'axios'

// 저장된 RoomFactory 계약 주소
const address = '0x6eAc1eeF72CcfA9c837aC031e7De4e0145a7610d'
          ...
          !this.state.isShowModal ? (
                ...
                rooms && rooms.length !== 0 &&
                  rooms.map(room => (
                    <Item>
                      ...
                      <Deposit>
                        <Label>Initial Deposit(ETH) Value</Label>
            ...
            <>
              ...
              <Footer>
                ...
                <button onClick={this.handleCreateRoom} className='save'>Save</button>
              </Footer>
            </>
          )
        }
